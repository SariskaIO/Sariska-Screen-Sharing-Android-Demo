...
public class NotificationUtils {
    ...
    private static final String NOTIFICATION_CHANNEL_ID = "com.example.sariskascreensharingdemo.app";
    private static final String NOTIFICATION_CHANNEL_NAME = "com.example.sariskascreensharingdemo.app";
    ...
    private static Notification createNotification(@NonNull Context context) {
        ...
        builder.setSmallIcon(R.drawable.baseline_photo_camera_24);
